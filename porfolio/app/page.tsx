            ...
            <div className="grid gap-10 px-10 md:gap-16 lg:grid-cols-2">
              <div className="space-y-4">
                ...
                <p className="text-gray-400">
                  I am a passionate full-stack developer with a strong background in web development. I love creating
                  beautiful and functional applications that solve real-world problems. In my free time, I enjoy
                  exploring
                  new technologies, contributing to open-source projects, and staying up-to-date with the latest
                  industry
                  trends.
                </p>
              </div>
              <div
                ...
                <div className="grid gap-1 text-sm relative">
                  ...
                  <div className="text-gray-400">
                    Responsible for designing and implementing complex web applications using React, Node.js, and
                    various
                    other technologies.
                  </div>
                </div>
          ...
          <div className="container px-4 md:px-6 flex flex-col items-center justify-center">
            <div className="space-y-4 text-center">
              ...
              <Carousel className="w-full flex items-center justify-center">
                <CarouselContent className="flex h-1/2 items-center justify-center w-1/3">
                  {projects.map((project, index) => (
                      <CarouselItem key={index} className="flex items-center justify-center">
                        <div
                            className="flex flex-col items-center rounded-lg border border-gray-800 bg-gray-950 p-4 shadow-sm">
                          <img src={project.image} alt={project.name} className="rounded-lg"/>
                          <div className="flex flex-col items-center justify-between h-full">
                            <div className="text-center">
                              <h3 className="text-lg font-medium">{project.name}</h3>
                              <p className="text-gray-400">{project.description}</p>
                              <h4 className="text-gray-400 mt-4">Languages
                                used: {Object.keys(project.languages).join(', ')}</h4>
                            </div>
